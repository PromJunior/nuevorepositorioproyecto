...
def dashboard_summary(
    ...
    return dashboard_crud.get_dashboard_summary(db=db, payment_method_id=payment_method_id)
...
def top_products(
    ...
    return dashboard_crud.get_top_products(db=db, limit=limit, payment_method_id=payment_method_id)
...
def top_clients(
    ...
    return dashboard_crud.get_top_clients(db=db, limit=limit, payment_method_id=payment_method_id)
...
def recent_sales(
    ...
    return dashboard_crud.get_recent_sales(db=db, limit=limit, payment_method_id=payment_method_id)
...
def sales_chart(
    ...
    return dashboard_crud.get_sales_chart(db=db, days=days, payment_method_id=payment_method_id)
...
def payment_method_stats(
    ...
    return dashboard_crud.get_payment_method_stats(db=db, payment_method_id=payment_method_id)
